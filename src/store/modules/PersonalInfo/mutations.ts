...
export const PersonalInfoMutations = {
  ...
  [MutationsType.SET_FORM_PAYMENT_INFO](state: PersonalInfoModuleState, value: PaymentInfo) {
    state.formPaymentInfo = value
  },

  [MutationsType.SET_FORM_RECEIVE_INFO](state: PersonalInfoModuleState, value: ReceiveInfo) {
