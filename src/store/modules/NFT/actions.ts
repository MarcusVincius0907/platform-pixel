...
export const NFTAction = {
  async [ActionTypes.GET_NFT_LIST](context: ActionContext<NFTModuleState, State>) {
  ...
  async [ActionTypes.GET_NFT_SUMMARY_ID_LIST](context: ActionContext<NFTModuleState, State>) {
    context.commit(MainMutationsType.SET_CUSTOM_LOADER, true)
  ...
  async [ActionTypes.GET_NFT_MEASUREMENT](context: ActionContext<NFTModuleState, State>, value: NFTParam) {
    context.commit(MainMutationsType.SET_CUSTOM_LOADER, true)
    ...
    const resp = await nftService.getNFTMeasurements(value.nftId, value.pixelSize)
  ...
  async [ActionTypes.CREATE_NFT](context: ActionContext<NFTModuleState, State>) {
  ...
  async [ActionTypes.UPDATE_NFT](context: ActionContext<NFTModuleState, State>) {
    if (context.state.formDataNFT) {
      context.commit(MainMutationsType.SET_CUSTOM_LOADER, true)
  ...
  async [ActionTypes.DELETE_NFT](context: ActionContext<NFTModuleState, State>) {
    if (context.state.formDataNFT) {
      context.commit(MainMutationsType.SET_CUSTOM_LOADER, true)
