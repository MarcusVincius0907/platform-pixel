...
export const NFTMutations = {
  ...
  [MutationsType.SET_NFT_LIST](state: NFTModuleState, value: Array<NFTSummary>) {
    state.nftSummaryList = value
  },

  [MutationsType.SET_NFT_ID_LIST](state: NFTModuleState, value: Array<NFTIdList>) {
    state.nftSummaryIdList = value
  },

  [MutationsType.SET_NFT_MEASUREMENT](state: NFTModuleState, value: NFTMeasurements) {
