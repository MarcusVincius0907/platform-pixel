...
export const CheckoutMutations = {
  [MutationsType.SET_CHECKOUT_REQUEST](state: CheckoutModuleState, value: CheckoutRequest) {
    state.checkoutRequest = value
  },

  [MutationsType.SET_CHECKOUT_RESPONSE](state: CheckoutModuleState, value: CheckoutResponse) {
