    ...
    <va-card-content>
      <div v-if="pixels?.length > 0" class="tw-bg-white tw-w-full tw-p-3 tw-py-5 tw-rounded-md">
        <div class="tw-flex tw-flex-col tw-items-center tw-justify-center tw-text-th-blue tw-py-2">
          ...
          <div class="tw-flex tw-flex-wrap tw-justify-center">
            <div v-for="(pixel, i) in pixels" :key="i" class="tw-font-bold tw-text-xl tw-pt-2 tw-m-1">
        ...
        <div class="tw-flex tw-flex-col tw-items-center tw-justify-center tw-text-th-blue tw-py-2">
          ...
          <div class="tw-font-bold tw-text-3xl tw-pt-2">R$ {{ pixels.length + ',00' }}</div>
        </div>

        <div class="tw-flex tw-justify-center tw-mt-4">
          <va-button v-if="!hideBuyButton" @click="onBuyPixel()" size="large"> Comprar agora </va-button>
        </div>
      </div>
      <div v-else class="tw-bg-white tw-w-full tw-flex tw-flex-col tw-justify-center tw-p-3 tw-py-5 tw-rounded-md">
        ...
        <div class="tw-font-bold tw-text-md tw-pt-4">
          Você pode selecionar um pixel clicando em qualquer quadrado e definindo a cor.
        </div>
      </div>
    </va-card-content>
  </va-card>
