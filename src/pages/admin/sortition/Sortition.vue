<template>
  <div class="tw-flex tw-justify-center tw-items-center w-full">
    <div class="tw-max-w-2xl tw-w-full">
      ...
      <div class="section">
        <div
          class="tw-w-full tw-flex tw-justify-center tw-items-center tw-mb-3"
        >
          <va-button class="tw-w-full" size="large" @click="openModalCreate()"
          >Criar novo sorteio</va-button
          >
        </div>
        <div
