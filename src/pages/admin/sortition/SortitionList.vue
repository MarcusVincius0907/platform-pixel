      ...
      <va-card-content>
        ...
        <div class="tw-flex tw-mb-3 tw-justify-center">
          <div class=" tw-w-1/2 tw-flex tw-flex-col tw-items-center">
            ...
            <div v-if="adminVisibilityAccess" class=" tw-cursor-pointer tw-underline" @click="goToNFT(sortition.idNFTSummary)">{{sortition.idNFTSummary.substring(0, 10)}}</div>
        ...
        <div v-if="adminVisibilityAccess" class=" tw-flex tw-justify-end">
          <va-button flat size="small" color="info" @click="openEditModal(sortition)">
            Editar
          </va-button>
        </div>
      </va-card-content>
