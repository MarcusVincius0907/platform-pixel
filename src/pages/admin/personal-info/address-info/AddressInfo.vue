        ...
        <va-form ref="formAddress" @validation="validation = $event">
          ...
          <div class="row">
            <div class="flex md4 sm6 xs12">
              <va-input v-model="formData.street" type="text" label="Rua" :rules="fieldsValidations.required">
              </va-input>
            </div>

            <div class="flex md4 sm6 xs12">
              <va-input v-model="formData.number" type="text" label="Número" :rules="fieldsValidations.required">
              </va-input>
            </div>

            <div class="flex md4 sm6 xs12">
              <va-input v-model="formData.complement" type="text" label="Complemento (opcional)"> </va-input>
            </div>

            <div class="flex md4 sm6 xs12">
              <va-input v-model="formData.district" type="text" label="Bairro" :rules="fieldsValidations.required">
              </va-input>
            </div>

            <div class="flex md4 sm6 xs12">
              <va-input v-model="formData.city" type="text" label="Cidade" :rules="fieldsValidations.required">
              </va-input>
            </div>

            <div class="flex md4 sm6 xs12">
              <va-input label="Estado" v-model="formData.state" type="text" :rules="fieldsValidations.required">
              </va-input>
            </div>
          </div>
          <va-button v-if="!hideSaveButton" @click="saveFormData($refs.formAddress.validate())" class="mr-2 mb-2">
            Salvar</va-button
          >
        </va-form>
      </va-card-content>
