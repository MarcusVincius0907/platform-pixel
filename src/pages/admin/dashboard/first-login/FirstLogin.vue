        ...
        <va-card>
          <va-card-content>
            <div class="tw-text-th-dark-green">
              ...
              <p class="tw-mb-3">
                Aqui na plataforma da L2M você pode concorrer a vários prêmios e
                receber muito dinheiro!
              </p>
              <p class="tw-mb-3">
                Mas antes, precisamos que preencha suas informações pessoais.
              </p>
            </div>
          </va-card-content>
        </va-card>
  ...
  methods: {
    createUser() {
      ...
      const isGeneralInfoValid = (
        this.$refs?.generalInfoRef as any
      )?.validate();
