                ...
                <div class="flex xs12">
                  <div class="">
                    <div class="tw-max-w-[250px] tw-m-auto tw-mb-5">
                      <img src="../../../../public/img/pix-logo.png" alt="" />
                    </div>
                    <div class="tw-ml-10 tw-max-w-[360px]">
                      <div class="tw-mb-2">
                        <i class="fa-solid fa-check"></i>
                        <span class="tw-ml-2 tw-text-sm"
                        >Copie ou faça a leitura do código QR Code através do
                          site ou app do seu banco</span
                        >
                      </div>
                      <div class="tw-mb-2">
                        <i class="fa-solid fa-check"></i>
                        <span class="tw-ml-2 tw-text-sm"
                        >O código é válido por 30 minutos</span
                        >
                      </div>
                      <div class="tw-mb-2">
                        <i class="fa-solid fa-check"></i>
                        <span class="tw-ml-2 tw-text-sm"
                        >O pedido só é confirmado após o pagamento</span
                        >
                      </div>
                    </div>
                  </div>
                ...
                <div class="flex xs12">
                  <div>
                    <div class="tw-flex tw-items-center tw-mb-3">
                      ...
                      <span class="ml-3"
                      >Você pode <strong> imprimir o boleto </strong> e pagar
                        no banco</span
                      >
                    </div>
                    <div class="tw-flex tw-items-center tw-mb-3">
                      ...
                      <span class="ml-3"
                      >Ou pode
                        <strong> pagar pela internet </strong> utilizando o
                        código de barras do boleto</span
                      >
                    </div>
                    <div class="tw-flex tw-items-center tw-mb-3">
                      <svg
                        class="tw-max-w-[40px]"
                        id="icon-calendar-rounded"
                        viewBox="0 0 64 64"
                      >
                        <path
                          fill="#666"
